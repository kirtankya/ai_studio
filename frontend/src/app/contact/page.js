  ...
  return (
    <div className="article-page">
      ...
      <div className="desc">
        ...
        <div style={{ marginTop: '1.5rem', padding: '1.5rem', background: 'var(--background)', borderRadius: '8px', border: '1px solid var(--border-color)', display: 'inline-block', maxWidth: '100%', wordBreak: 'break-word' }}>
