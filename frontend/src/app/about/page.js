  ...
  return (
    <div className="article-page">
      ...
      <div className="desc">
        ...
        <p>In today&apos;s fast-paced world, staying informed should not be difficult. Our platform is built on modern technology designed to monitor multiple trusted news sources and bring the most relevant stories directly to your screen. From the deepest corners of Gujarat to major International breaking news, we cover it all.</p>
